...
namespace QuanLyDeTaiNCKH.Controllers
{
    public class LoaiDeTaisController : Controller
    {
        ...
        {
            return View(db.LoaiDeTais.ToList());
        }
        ...
        public ActionResult Create([Bind(Include = "MaLoai,TenLoai")] LoaiDeTai loaiDeTai)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaLoai,TenLoai")] LoaiDeTai loaiDeTai)
        {
            if (ModelState.IsValid)
            {
